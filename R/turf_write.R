...
#'   uses the bundled template from the turf package, falling back to
...
#'   Default \code{0.20}.
#' @param very_hidden Logical. If \code{TRUE}, hidden sheets are set to
#'   "veryHidden". Default \code{FALSE}.
...
turf_write <- function(
  ...
  if(is.null(template)){
    template <- system.file("turf_template.xlsm", package = "turf")
    if(template == ""){
  ...
  # ---- Reorder sheets: Dashboard first, Best Combos second, then everything else ----
...
.turf_prepare_sheet <- function(tbl, top, col_info, vars_index = NULL){
  tbl <- tbl %>% dplyr::arrange(-.data$reach_pct, -.data$freq_avg)
...
.turf_write_config <- function(wb, subgroup_names, n_values, col_info,
  ...
  wb$add_data("_config", x = 2L, dims = "B10")
...
.turf_write_greedy_sheet <- function(wb, n_items){
  ...
  wb$set_col_widths("Greedy", cols = 1, widths = 6)
  wb$set_col_widths("Greedy", cols = 2, widths = 55)
  wb$set_col_widths("Greedy", cols = 3, widths = 10)
  wb$set_col_widths("Greedy", cols = 4, widths = 10)
  wb$set_col_widths("Greedy", cols = 5, widths = 10)
  wb$set_col_widths("Greedy", cols = 6, widths = 10)
}
...
.turf_write_dashboard <- function(
  ...
  wb$set_col_widths(sheet, cols = 1, widths = 2)
  wb$set_col_widths(sheet, cols = 2, widths = 10)
  wb$set_col_widths(sheet, cols = 3, widths = 8.5)
  wb$set_col_widths(sheet, cols = 4, widths = 3)
  wb$set_col_widths(sheet, cols = 5, widths = 10)
  wb$set_col_widths(sheet, cols = 6, widths = 8.5)
  wb$set_col_widths(sheet, cols = 7, widths = 3)
  wb$set_col_widths(sheet, cols = 8, widths = 10)
  wb$set_col_widths(sheet, cols = 9, widths = 8.5)
  wb$set_col_widths(sheet, cols = 10, widths = 3)
  wb$set_col_widths(sheet, cols = 11, widths = 12)
  wb$set_col_widths(sheet, cols = 12, widths = 8.5)
  wb$set_col_widths(sheet, cols = 13, widths = 3)
  wb$set_col_widths(sheet, cols = 14, widths = 8.5)
  wb$set_col_widths(sheet, cols = 15, widths = 8.5)
  wb$set_col_widths(sheet, cols = 16, widths = 5)
  wb$set_col_widths(sheet, cols = 17, widths = 6)
  wb$set_col_widths(sheet, cols = 18, widths = 20)
  wb$set_col_widths(sheet, cols = 19, widths = 35)
  wb$set_col_widths(sheet, cols = 20, widths = 10)
  wb$set_col_widths(sheet, cols = 21, widths = 8.5)
  wb$set_col_widths(sheet, cols = 22, widths = 8.5)
  wb$set_col_widths(sheet, cols = 23, widths = 8.5)
  wb$set_col_widths(sheet, cols = 24, widths = 10)
  wb$set_col_widths(sheet, cols = 25, widths = 3)
  wb$set_col_widths(sheet, cols = 26, widths = 20)
  wb$set_col_widths(sheet, cols = 27, widths = 35)
  wb$set_col_widths(sheet, cols = 28, widths = 10)

  if(!col_info$has_weights){
    wb$set_col_widths(sheet, cols = 11, hidden = TRUE)
    wb$set_col_widths(sheet, cols = 12, hidden = TRUE)
  }
...
.turf_write_best_combos <- function(wb, subgroup_names, n_values, col_info, base_sizes,
  ...
  wb$set_col_widths(sheet, cols = 1, widths = 2)
  wb$set_col_widths(sheet, cols = 2, widths = 12)
  wb$set_col_widths(sheet, cols = 3, widths = 12)
  wb$set_col_widths(sheet, cols = 4, widths = 10)
  for(i in seq_len(max_n)){
    wb$set_col_widths(sheet, cols = 4 + i, widths = 45)
  }
